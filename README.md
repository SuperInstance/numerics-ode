...
Research-grade ODE solvers: Euler, RK4, Adams-Bashforth, Dormand-Prince (adaptive RK45) — pure Rust, no dependencies
...
```bash
git clone https://github.com/SuperInstance/numerics-ode
cd numerics-ode
```
